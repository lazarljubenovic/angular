...
export abstract class AbstractControl {
   ...
   */
  public get errors(): ValidationErrors|null { return this._errors; }
   ...
   */
  public get pristine(): boolean { return this._pristine; }
  ...
  private _statusChanges = new Subject<any>();
   ...
   *
   */
  public readonly statusChanges: Observable<any> = this._statusChanges.asObservable();
